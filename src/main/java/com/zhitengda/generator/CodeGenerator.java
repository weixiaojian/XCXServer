...
public class CodeGenerator {
     ...
     * 数据库连结信息
     */
    private final String dbUrl = "jdbc:oracle:thin:@d-cityexp-tms.yundasys.com:8330/ydtc";
    private final String driver = "oracle.jdbc.driver.OracleDriver";
    private final String userName = "ydtc";
    private final String password = "ydtc#PW21(20";

    /**
     * 项目名
     */
    private final String projectName = "YDTCPXCXServer";
    /**
     * 指定包名
     */
     ...
     * 指定生成的表名（要大写）
     */
    private final String[] tableNames = new String[]{"T_INTERF_BALANCE_PAFEI_TASK"};

    /**
     * 项目路径
     */
    private final String path = "E:/idea-work/ztd/yunda/";
